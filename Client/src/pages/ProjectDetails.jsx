        ...
        <div className="space-y-5 max-w-6xl mx-auto text-zinc-900 dark:text-white">
            ...
            <div className="flex flex-wrap gap-4">
                {[
                    ...
                    <div key={idx} className="flex-1 min-w-36 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-200 dark:border-zinc-800 flex justify-between p-4 py-2.5 rounded">
                        <div>
